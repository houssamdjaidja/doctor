...
async function main() {
  ...
  const faqs = [
    ...
    { ci: fc2.rows[0].id, q: "Quels sont les horaires d'ouverture du cabinet ?", a: 'Le cabinet est ouvert du lundi au vendredi de 8h00 à 18h00, et le samedi de 9h00 à 12h00. Nous sommes fermés le dimanche et les jours fériés.', so: 1 },
